...
// `position: fixed` descendants (BottomNav, SosButton, and page-level
// fixed bars like the booking sticky bar), so they stay pinned to the
// edges of this column — whatever width it currently is — instead of
// the full viewport.
